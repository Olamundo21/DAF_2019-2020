...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\UserInterface\\Questions\\CreateQuestion' => 'getCreateQuestionService',
    ...
    protected function getAddQuestionHandlerService()
    {
        ...
        return $this->services['App\\Application\\Questions\\AddQuestionHandler'] = new \App\Application\Questions\AddQuestionHandler(($this->privates['App\\Infrastructure\\Persistence\\Doctrine\\Questions\\DoctrineQuestionsRepository'] ?? $this->getDoctrineQuestionsRepositoryService()), new \App\Infrastructure\Events\LeagueEventListener(($this->services['League\\Event\\EmitterInterface'] ?? ($this->services['League\\Event\\EmitterInterface'] = new \League\Event\Emmiter()))));
    }
    ...
    protected function getEditQuestionHandlerService()
    {
        ...
        return $this->services['App\\Application\\Questions\\EditQuestionHandler'] = new \App\Application\Questions\EditQuestionHandler(($this->privates['App\\Infrastructure\\Persistence\\Doctrine\\Questions\\DoctrineQuestionsRepository'] ?? $this->getDoctrineQuestionsRepositoryService()), new \App\Domain\Questions\Specification\OpenQuestion(), new \App\Domain\Questions\Specification\QuestionOwner(($this->privates['App\\Infrastructure\\HttpKernel\\EventListener\\ApiUserIdentifier'] ?? ($this->privates['App\\Infrastructure\\HttpKernel\\EventListener\\ApiUserIdentifier'] = new \App\Infrastructure\HttpKernel\EventListener\ApiUserIdentifier()))));
    }
    ...
    /**
     * Gets the public 'App\UserInterface\Questions\CreateQuestion' shared autowired service.
     *
     * @return \App\UserInterface\Questions\CreateQuestion
     */
    protected function getCreateQuestionService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/UserInterface/Questions/CreateQuestion.php';

        $this->services['App\\UserInterface\\Questions\\CreateQuestion'] = $instance = new \App\UserInterface\Questions\CreateQuestion(($this->privates['League\\Tactician\\CommandBus'] ?? $this->getCommandBusService()));

        $instance->setContainer(($this->privates['.service_locator.SXie53V'] ?? $this->get_ServiceLocator_SXie53VService())->withContext('App\\UserInterface\\Questions\\CreateQuestion', $this));
    ...
    /**
     * Gets the private '.service_locator.Vx0XK92' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Vx0XK92Service()
    {
        return $this->privates['.service_locator.Vx0XK92'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\UserInterface\\Questions\\CreateQuestion::withCurrentUser' => ['privates', '.service_locator.3xliQO6', 'get_ServiceLocator_3xliQO6Service', false],
            ...
            'App\\UserInterface\\Questions\\CreateQuestion::withCurrentUser' => '?',
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.Vx0XK92'] ?? $this->get_ServiceLocator_Vx0XK92Service())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
